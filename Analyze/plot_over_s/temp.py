...
Installation requirements:
    pip install trame trame-vuetify trame-components trame-matplotlib trame-plotly
"""
...
def on_filtered_data_change(filtered_data, **kwargs):
    ctrl.update_plot()  # Change to update_plot which will determine the active plot
...
with SinglePageWithDrawerLayout(server) as layout:
    layout.title.set_text("Plotly and Matplotlib Plots")
